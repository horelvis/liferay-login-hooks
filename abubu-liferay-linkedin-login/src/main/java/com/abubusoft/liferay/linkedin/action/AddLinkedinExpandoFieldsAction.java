...
package com.abubusoft.liferay.linkedin.action;

import com.abubusoft.liferay.linkedin.LinkedinConstants;
 ...
 */
public class AddLinkedinExpandoFieldsAction extends SimpleAction {
	
	private static Log _log = LogFactoryUtil.getLog(AddLinkedinExpandoFieldsAction.class);
	...
	protected void addColumn(long tableId, String name, UnicodeProperties properties) throws PortalException, SystemException {
		...
		ExpandoColumn linkedIn = ExpandoColumnLocalServiceUtil.addColumn(tableId, name, ExpandoColumnConstants.STRING);
