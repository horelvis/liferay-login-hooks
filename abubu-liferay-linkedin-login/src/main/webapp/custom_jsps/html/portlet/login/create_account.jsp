...
//---Custom code for login using Linkedin---//

String linkedinId = ParamUtil.getString(request, "linkedinId");	
...
<aui:form action="<%= createAccountURL %>" method="post" name="fm">
	...
	<aui:input name="linkedinId" type="hidden" value="<%= linkedinId %>" />
	...
	<aui:fieldset column="<%= true %>">
		...
		<aui:col width="<%= 50 %>">
			...
			<c:if test="<%= PropsValues.CAPTCHA_CHECK_PORTAL_CREATE_ACCOUNT && Validator.isNull(linkedinId) %>">
